...
Upload the module via the REDCap External Module Manager

Configure the required fields in the module's settings

Add the selected fields to your instrument
